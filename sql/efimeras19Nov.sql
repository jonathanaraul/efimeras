CREATE DATABASE  IF NOT EXISTS `efimeras` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `efimeras`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: efimeras
-- ------------------------------------------------------
...
CREATE TABLE `background` (
  ...
  CONSTRAINT `FK_BC68B4508D93D649` FOREIGN KEY (`user`) REFERENCES `fos_user` (`id`)
...
INSERT INTO `background` VALUES (4,1,1,1,'Efi1','853795ce12735e8e29be52e69be73c9723ad337d.jpeg','::1','0000-00-00 00:00:00','2014-07-29 03:46:00'),(5,1,1,1,'Efi2','0b453eb7b2a199c72bdd8d4716ce2eced50ad1b0.jpeg','::1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(6,1,1,1,'Efi3','9d5e5d16ada73e094a2014aecbe5b7666212bf36.jpeg','::1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(7,1,1,1,'Efi4','081e2387d76a33ae4daf492b58c39c834cc5b067.jpeg','::1','0000-00-00 00:00:00','2014-07-29 06:01:45'),(8,1,1,1,'Efi5','4afa2aa815cd0fca535fa5ba1ea02ffae4169d51.jpeg','::1','0000-00-00 00:00:00','2014-07-29 06:05:13'),(9,1,1,1,'Efi6','f6f02749ad154be5a5540a5c7712d448c5baf78e.jpeg','::1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(10,1,1,1,'Efi7','dd2b298a4af234442d784b4b4347e3ef80302c3e.jpeg','::1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(11,1,1,1,'Efi8','3e9fbe3a0da0d0ae2d3a0c3a7296d6972022ca2c.jpeg','::1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(12,1,1,1,'Efi9','0d95d349b4c01ab2e8492c202e130f3a5636dd3d.jpeg','::1','0000-00-00 00:00:00','2014-07-29 05:54:53');
...
CREATE TABLE `category` (
  ...
  CONSTRAINT `FK_64C19C17D053A93` FOREIGN KEY (`menu`) REFERENCES `menu` (`id`),
  CONSTRAINT `FK_64C19C18D93D649` FOREIGN KEY (`user`) REFERENCES `fos_user` (`id`),
  CONSTRAINT `FK_64C19C19775E708` FOREIGN KEY (`theme`) REFERENCES `theme` (`id`),
  CONSTRAINT `FK_64C19C1BC68B450` FOREIGN KEY (`background`) REFERENCES `background` (`id`)
...
INSERT INTO `category` VALUES (1,1,6,6,1,1,'noticias','noticias','Noticias','noticias','noticias',NULL,'noticias','tagnoticia1, tagnoticia2, tagnoticia3','<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur?</p>\r\n\r\n<p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</p>','::1','2014-07-22 05:44:51','2014-09-05 03:28:54',2,1);
...
INSERT INTO `email` VALUES (2,'jonathan.araul@gmail.com','2014-08-24 05:14:02','2014-08-24 05:14:02'),(3,'juan@gmail.com','2014-08-24 00:00:00','2014-08-24 00:00:00');
...
INSERT INTO `fos_user` VALUES (1,'jonathan.araul','jonathan.araul','jonathan.araul@gmail.com','jonathan.araul@gmail.com',1,'hxphtd1ox14w0csosog0kc0g4wsoko0','0xBgpAyww2D9amSwbBo0PtsvsCoDX2cQ65X4aOZ5CLDH3Y3B5apeCWi/kqHW8dJ5OLPnyDrOu4nl5iT8DybPRA==','2014-11-19 18:54:46',0,0,NULL,NULL,NULL,'a:2:{i:0;s:10:\"ROLE_ADMIN\";i:1;s:9:\"ROLE_USER\";}',0,NULL,'Jonathan Araul','1012871_817926508225412_2461521584647138733_n.jpg','2014-06-27 02:11:43','web developer'),(2,'R_Francos','r_francos','info@ramonfrancos.es','info@ramonfrancos.es',1,'dl8em23gup4oggo0ckg48ggcscgwwws','9KQAy6ZR2VWeXplfJZ4fWHIjdCkOP4S4vgmhM3ZCnPtmJoGEdXLDkMyMdiZKoT6a/davigBZ+u5iH5p5zAQuZA==','2014-07-15 19:50:46',0,0,NULL,NULL,NULL,'a:1:{i:0;s:9:\"ROLE_USER\";}',0,NULL,'RamÃ³n','photo.jpg','2014-07-15 19:50:45','Profesor'),(3,'REALEGO','realego','info@realego.es','info@realego.es',1,'jpsfl4lprrkc4044g8o0o48kowk0ggc','cokt+2bl2c2R4SA78AzWLYvUyQegl86jqc94RIYWb7oKDfipVg/6h+Fr4hGw6zCQHXUbgSI9NwhVtSkPZqmDRA==','2014-09-19 11:14:55',0,0,NULL,NULL,NULL,'a:1:{i:0;s:9:\"ROLE_USER\";}',0,NULL,'Realego','1622859_1375356429405551_897463730_n.jpg','2014-07-31 12:55:46','REALEGO Oficina Creativa'),(6,'director','director','director@gmail.com','director@gmail.com',1,'iydremlitkow8c04csskkgw4wwoock4','/XFFRSVEx30VsNutLLpRt9gMjKGiKbDjZr176XkSKcKmDd2oc869QQq/R3JxnyEiKoFjuY1tl3MDNwlZHA/jQA==','2014-09-11 20:29:03',0,0,NULL,NULL,NULL,'a:2:{i:0;s:9:\"ROLE_USER\";i:1;s:13:\"ROLE_DIRECTOR\";}',0,NULL,'director','8875a62414b7961d9a3e51e783abc57ef1c01e2e.png','2014-09-10 01:04:41','Director'),(7,'profesor','profesor','profesor@gmail.com','profesor@gmail.com',1,'j0vh3hj9w2ogocw80g4kkoog4cgw8wo','4VsIBu85F2jb9FWKXQ9gjCzmUp6xiQ5N0gk6GzO7zW251ieAWmj8P33yySsSczG6fxPF6ngKFVMHyDRI7MXqfA==','2014-09-11 20:31:33',0,0,NULL,NULL,NULL,'a:2:{i:0;s:9:\"ROLE_USER\";i:1;s:13:\"ROLE_PROFESOR\";}',0,NULL,'profesor','27e4413e361d9fc0be5bd4c80c26b61b3ef68564.png','2014-09-10 01:09:01','Profesor'),(8,'administrador','administrador','administrador@gmail.com','administrador@gmail.com',1,'k9794439h34400kwgs4gkco0o0k4cwk','O8+vz0rDd59B/UHlB3KNccX2MZpIIN8hH6LSRTwJGY8WcD4ptGRB9WlXJeYs2NW48q9HAyGw+3EK6DJV5zqxtA==','2014-09-10 01:11:06',0,0,NULL,NULL,NULL,'a:2:{i:0;s:9:\"ROLE_USER\";i:1;s:10:\"ROLE_ADMIN\";}',0,NULL,'administrador','7eac4560e1b00f7def04109dc4943f701e529fd5.png','2014-09-10 01:11:03','Administrador');
...
INSERT INTO `mensaje` VALUES (1,'miasunto','jonathan.araul@gmail.com','juan@gmail.com','Este es mi mensaje de prueba',0,'2014-08-23 22:56:12','2014-08-23 22:56:12'),(2,'Asunto','jonathan.araul@gmail.com','hjimenez45@gmail.com','Este es un mensaje de queja bla bla bla bla blaaaaa',0,'2014-08-23 23:04:07','2014-08-23 23:04:07');
...
CREATE TABLE `menu` (
  ...
  CONSTRAINT `FK_7D053A938D93D649` FOREIGN KEY (`user`) REFERENCES `fos_user` (`id`)
...
INSERT INTO `menu` VALUES (1,1,'Principal','Menu del front de efimeras',1,'2014-07-28 23:33:00','2014-07-31 12:59:16'),(2,1,'Menu Prueba','Menu prueba',1,'2014-09-03 06:36:43','2014-09-03 06:36:43'),(3,1,'Menu de ejemplo','Este es un menu de ejemplos',1,'2014-11-11 01:19:06','2014-11-11 01:19:06'),(4,1,'Nombre Menu dos','Esta es la descripcion que debe de llevar un menu segundo',1,'2014-11-11 14:50:53','2014-11-11 14:53:41'),(5,1,'Menu prueba','Texto de menu de prueba',1,'2014-11-18 22:50:40','2014-11-18 22:50:40');
...
CREATE TABLE `menu_item` (
  ...
  CONSTRAINT `FK_D754D550140AB620` FOREIGN KEY (`page`) REFERENCES `page` (`id`),
  CONSTRAINT `FK_D754D55064C19C1` FOREIGN KEY (`category`) REFERENCES `category` (`id`),
  CONSTRAINT `FK_D754D5507D053A93` FOREIGN KEY (`menu`) REFERENCES `menu` (`id`),
  CONSTRAINT `FK_D754D5508D93D649` FOREIGN KEY (`user`) REFERENCES `fos_user` (`id`)
...
INSERT INTO `menu_item` VALUES (1,1,1,NULL,1,'EFÃMERAS MASTER','MAster en Arquitectura EfÃ­mera',0,1,0,'2014-07-31 00:00:00','2014-07-31 13:20:16'),(2,1,NULL,1,1,'Noticias','Noticias',6,1,1,'2014-07-31 07:24:00','2014-07-31 13:33:02'),(3,1,2,NULL,1,'EXPERTO EN ARQUITETURAS INTERACTIVAS','Arquitecturas',2,1,0,'2014-07-31 13:20:05','2014-07-31 13:26:20'),(4,1,NULL,NULL,1,'Espacio 1','espacio 1',1,1,2,'2014-07-31 13:20:40','2014-07-31 13:21:00'),(5,1,NULL,NULL,1,'Espacio2','Espacio2',5,1,2,'2014-07-31 13:20:53','2014-07-31 13:33:02'),(6,1,3,NULL,1,'Experto en Arquitectura EfÃ­mera Social y Participativa','Experto en Arquitectura EfÃ­mera Social y Participativa',3,1,0,'2014-07-31 13:25:06','2014-07-31 13:27:55'),(7,1,4,NULL,1,'TÃ­tulo de Especialista en Instalaciones EfÃ­meras','TÃ­tulo de Especialista en Instalaciones EfÃ­meras',4,1,0,'2014-07-31 13:32:52','2014-07-31 13:33:02'),(8,2,1,NULL,1,'Master','master',1,1,0,'2014-09-03 06:37:49','2014-09-03 06:37:49'),(9,2,NULL,1,1,'Noticias','noticias',2,1,1,'2014-09-03 06:38:33','2014-09-03 06:38:33'),(10,5,2,NULL,1,'Item menu prueba 01','Texto de item menu prueba',1,1,0,'2014-11-18 22:53:59','2014-11-18 22:53:59');
...
INSERT INTO `newsletter` VALUES (2,'otro','','<p>otro mas</p>','2014-08-24 23:27:23','2014-08-24 23:27:23'),(3,'kdkjedne','','<p>excelente</p>','2014-08-24 23:39:30','2014-08-24 23:39:30'),(4,'ejemplificar','','<p>este es un nombre newsletter</p>','2014-11-11 14:20:12','2014-11-11 14:20:12');
/*!40000 ALTER TABLE `newsletter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `newsletters_emails`
--

DROP TABLE IF EXISTS `newsletters_emails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `newsletters_emails` (
  ...
  CONSTRAINT `FK_14D1DBA79173D44` FOREIGN KEY (`id_email`) REFERENCES `email` (`id`),
  CONSTRAINT `FK_14D1DBA7DB0F051F` FOREIGN KEY (`id_newsletter`) REFERENCES `newsletter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `newsletters_emails`
--

LOCK TABLES `newsletters_emails` WRITE;
/*!40000 ALTER TABLE `newsletters_emails` DISABLE KEYS */;
INSERT INTO `newsletters_emails` VALUES (3,2),(3,3),(4,2),(4,3);
/*!40000 ALTER TABLE `newsletters_emails` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `page` (
  ...
  CONSTRAINT `FK_140AB62064C19C1` FOREIGN KEY (`category`) REFERENCES `category` (`id`),
  CONSTRAINT `FK_140AB6207D053A93` FOREIGN KEY (`menu`) REFERENCES `menu` (`id`),
  CONSTRAINT `FK_140AB6208D93D649` FOREIGN KEY (`user`) REFERENCES `fos_user` (`id`),
  CONSTRAINT `FK_140AB6209775E708` FOREIGN KEY (`theme`) REFERENCES `theme` (`id`),
  CONSTRAINT `FK_140AB620BC68B450` FOREIGN KEY (`background`) REFERENCES `background` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `FK_42C84955140AB620` FOREIGN KEY (`page`) REFERENCES `page` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reservation` VALUES (1,2,'probando','3344','probando@gmail.com','10 junio','2014-08-23 23:09:31',0,1,4,1),(2,2,'Miguel Carmona','0424-9536347','miguelcar18@gmail.com','11-11-2014','2014-11-11 15:28:24',0,1,1,1);
...
INSERT INTO `search` VALUES (1,'master','2014-06-30 22:47:52','0000-00-00 00:00:00'),(2,'innovador','2014-06-30 22:48:21','0000-00-00 00:00:00'),(3,'efimera','2014-06-30 22:48:31','0000-00-00 00:00:00'),(4,'efimera','2014-06-30 22:48:38','0000-00-00 00:00:00'),(5,'innovador','2014-07-03 01:55:24','0000-00-00 00:00:00'),(6,'probando','2014-08-24 05:44:13','2014-08-24 05:44:13'),(7,'otro','2014-08-24 05:52:18','2014-08-24 05:52:18'),(8,'otromas','2014-08-24 05:52:47','2014-08-24 05:52:47'),(9,'otromas','2014-08-24 05:53:17','2014-08-24 05:53:17'),(10,'dnbcdbnvcbd','2014-11-11 13:41:16','2014-11-11 13:41:16');
...
CREATE TABLE `setting` (
  ...
  CONSTRAINT `FK_9F74B8988D93D649` FOREIGN KEY (`user`) REFERENCES `fos_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `setting` VALUES (1,1,'email','jonathan.araul@gmail.com',1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(2,1,'facebook','https://www.facebook.com/miguelcarmona88',1,'2014-08-24 21:55:59','2014-11-13 16:15:05'),(3,1,'twitter','https://twitter.com/',1,'2014-08-24 22:27:00','2014-08-24 22:27:00'),(4,1,'tuenti','https://www.tuenti.com/',1,'2014-08-25 03:43:46','2014-08-25 03:43:46'),(5,1,'pinterest','https://es.pinterest.com/',1,'2014-08-25 03:44:12','2014-08-25 03:44:12'),(6,1,'lugar','https://maps.google.es/maps/ms?ie=UTF8&t=h&oe=UTF8&msa=0&msid=213942746742807131548.00045a3cf2f7558f27c89&dg=feature',1,'2014-08-25 05:22:18','2014-08-25 05:22:18'),(7,1,'Telefono','913366497 / 913365272',1,'2014-08-25 05:30:12','2014-08-25 05:30:12'),(8,1,'email institucional','efimeras.arquitecturas@upm.es',1,'2014-08-25 05:31:04','2014-08-25 05:31:04');
...
INSERT INTO `theme` VALUES (1,'Purpura','#dcaccb','Purpura',1),(2,'Verde','#00ff3b','Verde fosforecente',1),(3,'probando','#f89406','Prueba',1),(4,'Naranja','#ff7a00','naranja',1),(5,'Azul oscuro','#3300ff','Azul oscuro',1),(6,'Amarillo','#fff500','Amarillado',1),(7,'INSTALACIONES EFÃMERAS','#d7579f','Tema para el curso de especializaciÃ³n en Instalaciones EfÃ­meras.',1);
...
-- Dump completed on 2014-11-19 14:58:25
