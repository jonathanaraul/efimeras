...
class ImageController extends Controller {
	...
	public function listAction(Request $request) {
		...
		$url = $this -> generateUrl('project_back_image_list');
		$form = null;		
		$filtros = null;
		...
		return $this -> render('ProjectBackBundle:Image:list.html.twig', $array);
	}

	public function createAction(Request $request) {

		$array = array('accion' => 'nuevo');
		$array['url'] = $this -> generateUrl('project_back_image_create');
		$array['data'] = new Imagen();

		return ImageController::procesar($array, $request, $this);
	}

	public function editAction($id, Request $request) {

		$array = array('accion' => 'edicion');
		$array['url'] = $this -> generateUrl('project_back_image_edit', array('id' => $id));
		$array['id'] = $id;

		$array['data'] = $this -> getDoctrine() -> getRepository('ProjectUserBundle:Imagen') -> find($id);
	...
	public static function procesar($array, Request $request, $class) {
		...
		$form = $class-> createForm('image', $data);
		...
		// Procesa accion en base de datos
        	...
        	return $class-> redirect($class-> generateUrl('project_back_image_list'));
        }

		$array['form'] = $form-> createView();

		return $class -> render('ProjectBackBundle:Image:new-edit.html.twig', $array);
	}
